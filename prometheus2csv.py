...
CONTAINERLIST = ['docker-compose_alertmanager_1','docker-compose_carts-db_1','docker-compose_carts_1','docker-compose_catalogue-db_1',
 'docker-compose_catalogue_1','docker-compose_edge-router_1','docker-compose_elasticsearch_1','docker-compose_front-end_1',
 'docker-compose_grafana_1','docker-compose_kibana_1','docker-compose_log-server_1','docker-compose_orders-db_1',
 'docker-compose_orders_1','docker-compose_payment_1','docker-compose_queue-master_1','docker-compose_rabbitmq_1',
 'docker-compose_shipping_1','docker-compose_user-db_1','docker-compose_user_1','mypytorch','prometheus','weavescope']
...
def query_tiandi_metric_names():
    ...
    for instanceName in range(len(INSTANCELIST)):
        for index in range(len(TiandiMetricNames2)):
            metricName.append(INSTANCELIST[instanceName] + "/" + TiandiMetricNames[index])
    print(metricName)
    return metricName
